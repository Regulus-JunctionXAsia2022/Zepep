...
let left_ani = ScriptApp.loadSpritesheet("pet.png", SPRITE_WIDTH, SPRITE_HEIGHT, [12, 13, 14, 15], 8);
let up_ani = ScriptApp.loadSpritesheet("pet.png", SPRITE_WIDTH, SPRITE_HEIGHT, [8, 9, 10, 11], 8);
let down_ani = ScriptApp.loadSpritesheet("pet.png", SPRITE_WIDTH, SPRITE_HEIGHT, [2, 3, 4, 5, 6, 7], 8);
let right_ani = ScriptApp.loadSpritesheet("pet.png", SPRITE_WIDTH, SPRITE_HEIGHT, [20, 21, 22, 23], 8);
            ...
            for (let i in _players) {
                ...
                if (p.tag.previousX !== p.tileX || p.tag.previousY !== p.tileY || p.tag.previousDir !== p.dir) {
                    if (p.tag.previousDir % 4 === 1) {
                        ...
                        ScriptMap.putObject(p.tag.previousX, p.tag.previousY, left_ani, {overlap: true, moveSpeed: 80})
                    ...
                    if (p.tag.previousDir % 4 === 2) {
                        ScriptMap.putObject(p.tag.previousX, p.tag.previousY, null)
                        ScriptMap.putObject(p.tag.previousX, p.tag.previousY, up_ani, {overlap: true, moveSpeed: 80})
                    ...
                    if (p.tag.previousDir % 4 === 3) {
                        ScriptMap.putObject(p.tag.previousX, p.tag.previousY, null)
                        ScriptMap.putObject(p.tag.previousX, p.tag.previousY, right_ani, {overlap: true, moveSpeed: 80})
                    ...
                    if (p.tag.previousDir % 4 === 0) {
                        ScriptMap.putObject(p.tag.previousX, p.tag.previousY, null)
                        ScriptMap.putObject(p.tag.previousX, p.tag.previousY, down_ani, {overlap: true, moveSpeed: 80})
                    ...
                    ScriptMap.putObject(p.tag.previousX, p.tag.previousY, null)
                    ScriptMap.putObject(p.tag.previousX, p.tag.previousY, sit_ani, {overlap: true, moveSpeed: 80})
                }
                p.sendUpdated()
